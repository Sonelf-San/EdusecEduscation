...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{ asset('storage/logos/' . $school->logo->image) }}" alt = "Image..." class="mb-3" width = "50">
                    <img src="{{ asset('storage/schools/' . $school->image) }}" alt = "Image..." class="img-fluid mb-3">
                    <h3 class="text-capitalize mb-0">{{$school->acronym}} : {{ $school->name }}</h3>
                    <p class="mb-0"><span class="fa fa-stopwatch"></span> {{ $school->created_at->diffForHumans() }}
                    </p>
                            ...
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('admin.schools.destroy', $school->id) }}">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                Are you sure you want to delete this event ({{ $school->name }}) ?
                                            </div>
                                        </div>
                                    </div>
