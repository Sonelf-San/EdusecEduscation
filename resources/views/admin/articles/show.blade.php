                            ...
                            @foreach($article->art_files as $gal)
                                <div class="item mr-3 mt-2">
                                    <a href="#" class="remove-image"
                                       ...
                                       <ul>
                                            <li>
                                            <a href="{{ asset('storage/articles/'.$gal->file) }}" alt="" class = "text-center">{{$gal->file}}</a>
                                            </li>
                                        </ul>
                                </div>
                            @endforeach
            ...
            $(function () {
                ...
                $('.remove-image').on('click', function ($e) {
                    ...
                    delete_modal.find('form')
                        .attr('action', '{{ route('admin.article_files.delete', ['id' => 'CM']) }}'.replace('CM', image_id));
