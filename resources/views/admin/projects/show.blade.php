...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="card">
                <div class="card-body">
                    <img src="{{ asset('storage/projects/' . $project->image) }}" alt = "Image..." class="img-fluid mb-3">
                    <h3 class="text-capitalize mb-0">{{ $project->title }}</h3>
                    <p class="mb-0"><span class="fa fa-stopwatch"></span> {{ $project->created_at->diffForHumans() }}
                    </p>
                    <hr>
                            ...
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('admin.projects.destroy', $project->id) }}">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                Are you sure you want to delete this activity ({{ $project->title }}) ?
                                            </div>
                                        </div>
                                    </div>
