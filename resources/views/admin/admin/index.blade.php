...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Comptes Administrateur</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="filter">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <div class="d-flex flex-nowrap align-items-center">
                        ...
                        <a href="{{route('admin.administrator.create')}}" class="btn btn-info text-white btn-sm">Ajouter un administrateur</a>
                    </div>
                 </div>
            ...
            {{ $admins->appends(['q'=>$search['q'], 'limit' =>$search['limit']])->links()}}
        </div>
    </div>
