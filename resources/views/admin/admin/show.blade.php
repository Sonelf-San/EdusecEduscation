            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin.administrator.index') }}">Comptes
                                Administrateur</a></li>
            ...
            <div class="card-box text-center">
                ...
                <div class="text-left mt-3">
                    <p class="text-muted mb-2 font-13">
                        <strong>Nom complet :</strong> <span class="ml-2">{{ $user->name }}</span>
                    </p>
                    <p class="text-muted mb-2 font-13">
                        <strong>Téléphone :</strong><span class="ml-2">{{ $user->phone ?: 'N/A' }}</span>
                    </p>
                    ...
                    <p class="text-muted mb-1 font-13">
                        <strong>Adresse 1 :</strong> <span class="ml-2">{{ $user->address_1 ?: 'N/A' }}</span></p>
                    <p class="text-muted mb-1 font-13">
                        <strong>Adresse 2 :</strong> <span class="ml-2">{{ $user->address_2 ?: 'N/A' }}</span></p>
                </div>
                <hr>
